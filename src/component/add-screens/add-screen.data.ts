...
export const screensDropdown = [
  ...
  { id: 7, label: "Swipe Help", value: "swipe-help", modal: ShowModalActivitySwipeHelp },
  { id: 8, label: "Thinking Traps", value: "thinking-traps", modal: ShowModalThinkingTraps },
  { id: 9, label: "Grounding Exercise", value: "grounding-exercise", modal: ShowModalGroundingExercise },
